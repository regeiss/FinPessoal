...
final class UserTests: XCTestCase {
    ...
    func testUserPreferencesFromDictionaryWithMissingFields() throws {
        ...
        let preferences = try XCTUnwrap(UserPreferences.fromDictionary(partialDictionary))
    ...
    func testUserWithSpecialCharacters() throws {
        ...
        XCTAssertEqual(specialCharUser.profileImageURL, "https://example.com/profile?id=123&size=large")
    }
}