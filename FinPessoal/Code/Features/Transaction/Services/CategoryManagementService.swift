...
class CategoryManagementService: ObservableObject {
    ...
    private func calculateCategoryUsage(from transactions: [Transaction]) -> [String: CategoryUsage] {
    ...
    func updateCategory(_ category: BuiltInCategory, name: String, icon: String, color: String) async throws {
    ...
    func validateCategoryName(_ name: String, excludingId: String? = nil) -> Bool {
        ...
        let existingNames = customCategories
