...
struct ThemedDashboardExample: View {
            ...
            HStack {
                ...
                Button(action: {}) {
                    Image(systemName: "gearshape.fill")
                        .font(.title2)
                        .foregroundColor(colorScheme == .dark ? AppTheme.DarkColors.syntaxBlue : AppTheme.LightColors.syntaxBlue)
                }
            }
        }
    }
                    ...
                    VStack(alignment: .leading, spacing: 8) {
                        HStack {
                            Image(systemName: "arrow.down.circle.fill")
                                .foregroundColor(colorScheme == .dark ? AppTheme.DarkColors.syntaxGreen : AppTheme.LightColors.syntaxGreen)
                    ...
                    VStack(alignment: .leading, spacing: 8) {
                        HStack {
                            Image(systemName: "arrow.up.circle.fill")
                                .foregroundColor(colorScheme == .dark ? AppTheme.DarkColors.expenseRed : AppTheme.LightColors.expenseRed)
    ...
    private var recentTransactionsSection: some View {
        ThemedCard(padding: EdgeInsets(top: 16, leading: 0, bottom: 16, trailing: 0)) {
